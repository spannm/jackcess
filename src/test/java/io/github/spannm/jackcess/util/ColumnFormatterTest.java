...
class ColumnFormatterTest extends AbstractBaseTest {
    ...
    @FileFormatSource
    void format(FileFormat fileFormat) throws Exception {
        try (Database db = createDbMem(fileFormat)) {
            ...
            assertThat(t.getColumn("data1").getProperties()
                    .getValue(PropertyMap.FORMAT_PROP)).isEqualTo("Scientific");
            assertThat(t.getColumn("data3").getProperties()
                    .getValue(PropertyMap.FORMAT_PROP)).isEqualTo("General Date");
