...
import static io.github.spannm.jackcess.TestUtil.openCopy;
...
public class JetFormatTest extends TestCase {
    ...
    static {
        ...
        List<FileFormat> supported = new ArrayList<>();
        List<FileFormat> supportedForRead = new ArrayList<>();
    ...
    public static final class TestDB {
        ...
        public JetFormat getExpectedFormat() {
