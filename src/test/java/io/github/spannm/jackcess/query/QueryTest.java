...
class QueryTest extends AbstractBaseTest {
    ...
    void readQueries(TestDb testDb) throws Exception {
        ...
        expectedQueries.put("SelectQuery", multiline(
        ...
        expectedQueries.put("DeleteQuery", multiline(
            "DELETE Table1.col1, Table1.col2, Table1.col3",
            "FROM Table1",
            "WHERE (((Table1.col1)>\"blah\"));"));
        expectedQueries.put("AppendQuery", multiline(
        ...
        expectedQueries.put("CrosstabQuery", multiline(
        ...
        expectedQueries.put("PassthroughQuery", "ALTER TABLE Table4 DROP COLUMN col5;\0");
        expectedQueries.put("DataDefinitionQuery", "CREATE TABLE Table5 (col1 CHAR, col2 CHAR);\0");
