...
/**
 * Builder style class for constructing a {@link Cursor}. By default, a cursor is created at the beginning of the table,
 * and any start/end rows are inclusive.
 * <p>
...
public class CursorBuilder {
    ...
    /**
     * Sets the starting and ending row for a range based index cursor to the given entry (where the given values
    ...
    /**
     * Sets the starting row for a range based index cursor to the given entry (where the given values correspond to the
     * index's columns).
     * <p>
     * A valid index must be specified before calling this method.
     */
    ...
    /**
     * Sets the ending row for a range based index cursor to the given entry (where the given values correspond to the
     * index's columns).
     * <p>
     * A valid index must be specified before calling this method.
     */
     ...
     *
     * @param index index for the table which will define traversal order as well as enhance certain lookups
     * @param startRow the first row of data for the cursor (inclusive), or {@code null} for the first entry
    ...
    /**
     * Convenience method for finding a specific row (as defined by the cursor) where the index entries match the given
     * values. See {@link IndexCursor#findRowByEntry(Object...)} for details on the entryValues.
     *
    ...
    /**
     * Convenience method for finding a specific row by the primary key of the table. See
     * {@link IndexCursor#findRowByEntry(Object...)} for details on the entryValues.
     *
     * @param table the table to search
    ...
    /**
     * Convenience method for finding a specific row in a table which matches a given row "pattern". See
     * {@link Cursor#findFirstRow(Column,Object)} for details on the pattern.
     * <p>
     * Note, a {@code null} result value is ambiguous in that it could imply no match or a matching row with
     * {@code null} for the desired value. If distinguishing this situation is important, you will need to use a Cursor
     ...
     * @param valuePattern value from the columnPattern which will match the desired row
     * @return the matching row or {@code null} if a match could not be found.
     */
