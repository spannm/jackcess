...
import static com.healthmarketscience.jackcess.impl.expr.FunctionSupport.getOptionalDoubleParam;
...
public class DefaultFinancialFunctions {
    ...
    private static int getPaymentType(EvalContext ctx, Value[] params, int idx) {
        ...
        if (params.length > idx) {
            pmtType = params[idx].getAsLongInt(ctx) != PMT_END_MNTH ? PMT_BEG_MNTH : PMT_END_MNTH;
        }
        return pmtType;
    }
}
