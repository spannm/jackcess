...
public final class ByteUtil {
     ...
     * @return a new buffer with the given number of bytes from the current position in the given buffer
     */
     ...
     * @param len length of the desired bytes
     * @return a new buffer with the given number of bytes from the given position in the given buffer
     */
    ...
    /**
     * Inserts empty data of the given length at the current position of the given buffer (moving existing data forward
     * the given length). The limit of the buffer is adjusted by the given length. The buffer is expecting to have the
