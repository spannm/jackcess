...
class TextColumnImpl extends ColumnImpl {
    ...
    private final boolean   compressedUnicode;
    ...
    TextColumnImpl(InitArgs args) {
        ...
        sortOrder = readSortOrder(args.buffer, args.offset + getFormat().OFFSET_COLUMN_SORT_ORDER, getFormat());
        codePage = readCodePage(args.buffer, args.offset, getFormat());

        compressedUnicode = (args.extFlags & COMPRESSED_UNICODE_EXT_FLAG_MASK) != 0;
    }
