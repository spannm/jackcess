...
public class UsageMap {
    ...
    private class GlobalInlineHandler extends InlineHandler {
        ...
        /**
         * Shifts the inline usage map so that it now starts with the given firstPage (if valid), otherwise the
         * newPageNumber. Any page numbers added to the end of the usage map are set to "on".
         *
        ...
        private void moveToNewStartPageForRemove(int firstPage, int newPageNumber) throws IOException {
            ...
            if (firstPage <= PageChannel.INVALID_PAGE_NUMBER) {
                ...
                ByteUtil.fillRange(tableBuffer, getInlineDataStart(), getInlineDataEnd());
