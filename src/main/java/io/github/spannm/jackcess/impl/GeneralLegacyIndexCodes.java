...
public class GeneralLegacyIndexCodes {
    ...
    /**
     * Returns an the char value converted to an unsigned char value. Note, I think this is unnecessary (I think java
     * treats chars as unsigned), but I did this just to be on the safe side.
     */
    ...
    /**
     * Encode the suffix which follows the crazy codes into the given byte stream.
     */
    private static void writeCrazyCodesSuffix(int numCrazyChars, ByteStream bout) {
        int numRepeats = (numCrazyChars + (CRAZY_CODES_PER_SUFFIX_REPEAT - 1)) / CRAZY_CODES_PER_SUFFIX_REPEAT;
    ...
    private static void writeCrazyCodesSuffixRepeats(int numRepeats, ByteStream bout) {
