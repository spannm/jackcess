...
public class ImportUtil {
    ...
    /**
     * Returns a List of Column instances converted from the given ResultSetMetaData (this is the same method used by
     * the various {@code
     ...
     * Copy a delimited text file into a new table in this database.
     * <p>
     * Equivalent to: {@code  importFile(f, name, db, delim, "'", filter, false);}
     *
     * @param name Name of the new table to create
     * @param f Source file to import
     * @param delim Regular expression representing the delimiter string.
     ...
     * Copy a delimited text file into a new (or optionally exixsting) table in this database.
     * <p>
     * Equivalent to: {@code  importReader(in, db, name, delim, '"', filter, useExistingTable, true);}
     *
     * @param name Name of the new table to create
     * @param in Source reader to import
     * @param delim Regular expression representing the delimiter string.
    ...
    /**
     * Splits the given line using the given delimiter pattern and quote character. May read additional lines for quotes
     * spanning newlines.
     */
